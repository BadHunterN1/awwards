	...
	return (
		<>
			<div
				...
				<Tap setPosition={setPosition}>features</Tap>
				<Tap setPosition={setPosition}>about</Tap>
				<Tap setPosition={setPosition}>contact</Tap>
				<motion.div
					animate={position}
					className={
						"absolute z-0 h-5 w-36 rounded-full bg-white md:h-10 self-center"
					}
				/>
			</div>
		</>
